export const environment = {
  production: true,
  oneSignalIosId: '36429e72-ef56-4b70-9ce4-0a286d8f359a',
  oneSignalAndroidSenderId: '1046479883978',
  speakersApiUrl: 'https://www.nerna.org/nerna_scripts/conventions.json',
