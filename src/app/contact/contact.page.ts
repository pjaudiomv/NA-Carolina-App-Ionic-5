...
export class ContactPage implements OnInit {
  ...
  sourceCodeLink = 'https://github.com/pjaudiomv/NA-Carolina-App-Ionic-4';
  sourceBugs = 'https://github.com/pjaudiomv/NA-Carolina-App-Ionic-4/issues';
  ...
  getServiceGroupContactDetails() {
    this.ServiceGroupsProvider.getAllServiceGroups().subscribe((serviceGroupData) => {
      ...
      this.serviceGroupNames.sort((a, b) => a.name.localeCompare(b.name));
